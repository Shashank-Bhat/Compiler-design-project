...
start:T_INT T_MAIN T_OPEN T_CLOSE comp_stat  {$$ = make_leaf($1); $$=make_node("Main",$1,$5);printf("\n\nAbstract Syntax Tree:\n\n"); AST_print($$); 																printf("\n\n");print_sym_tab(); YYACCEPT;}   
     ;
...
iter_stat:T_WHILE T_OPEN cond T_CLOSE comp_stat		{$$=make_node("While",$3,$5);}
		 ;
...
decl:Type Varlist T_SC    {$1=make_leaf($1); $$=make_leaf($2); $$=make_node("Variable_Declaration",$1,$2); }     
    |Type assign_expr1   {$1=make_leaf($1); $$=make_node("Variable_Declaration",$1,$2);} 
    ;
